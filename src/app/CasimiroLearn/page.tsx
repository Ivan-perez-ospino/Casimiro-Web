...
import NavBarDashboardStudent from '../components/NavbarDasboard';
  ...
  return (
    <Fragment>
      ...
      <div className='my-20 px-10 max-[530px]:px-5'>
        <div className='grid place-items-center place-content-between grid-cols-2 max-tablet:grid-cols-1 my-20'>
          <div>
        ...
        <div className='grid gap-5 place-items-center place-content-between grid-cols-3 max-tablet:grid-cols-1 my-10'>
