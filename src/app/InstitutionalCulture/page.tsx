  ...
  return (
    <Fragment>
      <section>
        ...
        <section className='grid grid-cols-2 p-10 max-tablet:grid-cols-1'>
          <article className='max-tablet:my-10'>
          ...
          <article className='max-tablet:my-10'>
            ...
            <div className='flex flex-col items-center justify-center my-10'>
              ...
              <p className='max-[510px]:text-xs'>Simboliza los saberes y la formacion integral que brinda la institucion.</p>
            </div>
            <div className='flex flex-col items-center justify-center my-10'>
              ...
              <p className='max-[450px]:text-xs'>La bandera de la Institución Educativa “Casimiro Raúl Maestre” tiene dos franjas horizontales de la misma dimensión, la primera blanca y la segunda azul las cuales significan:</p>
              <div className='my-5'>
                <p className='max-[450px]:text-xs'><i className='font-bold max-[450px]:text-xs'>Blanco: </i>La fe, la creencia en Dios y la Paz que deseamos para nuestro país la tranquilidad,  la armonía que deben existir en la Institución.</p>
                <p className='max-[450px]:text-xs'><i className='font-bold max-[450px]:text-xs'>Azul: </i>El esfuerzo continúo en el estudio para la superación y el éxito (perseverancia).</p>
              </div>
            </div>
          </article>
        </section>
