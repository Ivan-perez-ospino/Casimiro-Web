...
import { Navbar, NavbarBrand, NavbarContent, NavbarItem, NavbarMenuToggle, NavbarMenu, NavbarMenuItem, Button, Card, CardHeader, CardBody } from '@nextui-org/react';
...
export default function HomePage(): JSX.Element {
  ...
  return (
    <Fragment>
      <Navbar className='h-18 justify-evenly' shouldHideOnScroll onMenuOpenChange={setIsMenuOpen}>
        <NavbarMenuToggle
      ...
      <footer className='bg-slate-100 text-black py-6'>
        <section className='flex items-start justify-evenly flex-wrap gap-10'>
          <div className='flex flex-col max-tablet:items-center max-tablet:justify-center'>
            ...
            <Link href='/MissionAndVision' className='hover:text-slate-600'>
              Mision Y Vision
            </Link>
            <Link href='' className='hover:text-slate-600'>
          ...
          <div className='flex flex-col max-tablet:items-center max-tablet:justify-center'>
            <h1 className='font-bold text-xl'>ESCUELAS</h1>
            <Link href='' className='hover:text-slate-600'>
              Daniel Tapias Pico
            </Link>
            <Link href='' className='hover:text-slate-600'>
